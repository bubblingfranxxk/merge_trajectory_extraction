...
lanlet2data = {
    ...
    "2": {
        ...
        # 直行区域
        "mainline": [1489, 1488, 1493, 1492, 1498, 1499, 1501, 1502, 1504, 1574, 1508, 1509],
        # 上游区域
    ...
    "3": {
        ...
        "exit": [1445, 1447, 1451],
        "mainline": [1402, 1403, 1404, 1405, 1411, 1412, 1413, 1414, 1523, 1524, 1527, 1528, 1421, 1422],
    ...
    "5": {
        ...
        "onramp": [1405, 1448],
        "exit": [],
        "mainline": [1407, 1408, 1410, 1411, 1413, 1414, 1417, 1418],
    ...
    "6": {
        ...
        "onramp": [1447, 1455],
        "exit": [],
        "mainline": [1462, 1463, 1461, 1465, 1467],
